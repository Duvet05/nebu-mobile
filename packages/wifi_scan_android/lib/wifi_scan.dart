...
class WiFiScan {
  ...
  Future<List<WiFiAccessPoint>> getScannedResults() async {
    final scannedResults = await _channel
        .invokeListMethod<Map<Object?, Object?>>('getScannedResults');
    return (scannedResults ?? const <Map<Object?, Object?>>[])
        .map(WiFiAccessPoint._fromMap)

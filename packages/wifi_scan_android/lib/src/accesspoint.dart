...
class WiFiAccessPoint {
  WiFiAccessPoint._fromMap(Map<Object?, Object?> map)
    : ssid = map['ssid']! as String,
      ...
      standard = _deserializeWiFiStandards(map['standard'] as int?),
      centerFrequency0 = map['centerFrequency0'] as int?,
      centerFrequency1 = map['centerFrequency1'] as int?,
      channelWidth = _deserializeWiFiChannelWidth(map['channelWidth'] as int?),
      isPasspoint = map['isPasspoint'] as bool?,
      operatorFriendlyName = map['operatorFriendlyName'] as String?,
      venueName = map['venueName'] as String?,
      is80211mcResponder = map['is80211mcResponder'] as bool?;
  ...
  // TODO(nebu): Parse this into security enums.
  ...
  // TODO(nebu): Rename to RSSI and expose a signal-quality enum.
  final int level;

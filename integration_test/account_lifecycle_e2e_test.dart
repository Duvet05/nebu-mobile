...
void main() {
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      await _enterText(tester, 'signup.passwordField', _password);
      await _enterText(tester, 'signup.confirmPasswordField', _password);
      ...
      expect(backend.registrationBody, containsPair('password', _password));
      ...
      await _enterText(tester, 'privacy.deletePasswordField', _password);
      await tester.tap(
      ...
      expect(backend.deletionBody, containsPair('password', _password));
  ...
  Future<ResponseBody> fetch(
    ...
    if (method == 'DELETE' && path == '/users/me') {
      ...
      if (!verified ||
          ...
          deletionBody['password'] != _password) {
        return _jsonResponse(<String, dynamic>{'error': 'Unauthorized'}, 401);
      }
      deleted = true;
      return _jsonResponse(<String, dynamic>{
